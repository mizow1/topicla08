...
必ず以下の構成で各議題ごとに「結論」→「根拠」→「補足説明」の順で回答してください。
...
上記の構成で、実際のHTMLタグやテキスト例を含む実行可能な改善案を提示してください。モバイルファーストインデックス、Core Web Vitals、日本語SEOの特性も考慮してください。";
